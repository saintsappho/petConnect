...
export default function Navbar({ handleHide, handlePetListSelect, petData, openCurrentUserModal, user, userId, accessToken, showAddPetForm, setShowAddPetForm }) {
  ...
  <>
    ...
    <PetListWidget handlePetListSelect={handlePetListSelect} handleHide={handleHide} setShowAddPetForm={setShowAddPetForm} showAddPetForm={showAddPetForm} user={user} petData={petData} listPayload="currentUser" userId={userId} divClass="nav-pet-widget"/>
    </div>
