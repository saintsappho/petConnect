...
export default function HomeRoute({ onPetSelect, petData, handlePetListSelect, openCurrentUserModal, setPetData, closeModal, userId, setPetPoints }) {
  ...
  const [fetchError, setFetchError] = useState(null);
    ...
    return (
      <div className="HomeRoute">
        ...
        <PetPointsFeedWidget setPetPoints={setPetPoints} userId={userId}/>
