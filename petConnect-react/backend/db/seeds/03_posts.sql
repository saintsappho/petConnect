...
VALUES
  ...
  (6, 6, 'event-post', 'Weight Journey', 'Started a new diet, tracking progress here!', '2024-02-06', NULL),
  ...
  (3, 1, 'event-post', '10k Steps Challenge', 'Who else is joining the 10k steps challenge?', '2024-02-09', NULL),
  ...
  (5, 5, 'event-post', 'Vaccination Day', 'Got up to date with vaccinations today.', '2024-02-12', NULL),
